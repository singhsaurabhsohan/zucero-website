...
export default function ShippingPage() {
  return <ContentPage eyebrow="Delivery, clearly explained" title="Shipping policy" intro="Zucero currently ships within India from Haryana. Delivery serviceability is checked before payment.">
    <h2>Shipping charges</h2><p>For the India launch, shipping is ₹79 for Haryana deliveries and ₹129 for deliveries to other Indian states and union territories. Product subtotals of ₹1,499 or more receive free standard shipping.</p>
