...
export function ProductGallery({ product }: { product: Product }) {
  const photos = [{ src: product.image, label: product.name }, { src: product.slug === "desi-khand" ? "/images/khand_texture.webp" : "/images/slow_sweetness.webp", label: product.slug === "desi-khand" ? "Khand texture" : "Mishri serving inspiration" }, { src: "/images/sugarcane_origin.webp", label: "Sugarcane inspiration" }];
