...
export function HeritageSections() {
  return <div className="heritage">
    ...
    <section id="process" className="heritage-dark heritage-craft">
      <div className="heritage-panorama"><Image src="/images/artisan_hands.webp" alt="Traditional sugar-making in a brass vessel" fill sizes="100vw" /><div className="section-image-caption"><span>The Craft</span><strong>Good takes time.</strong></div></div>
    ...
    <section className="heritage-dark heritage-slow"><div><p className="eyebrow">Chapter 04</p><h2>Slow<br /><em>sweetness.</em></h2><span className="heritage-rule" /><p>There is something that happens when Mishri dissolves slowly in hot water. You wait for it. That waiting is the ritual. Not the sugar itself, but what it asks of you.</p></div><div className="heritage-panorama"><Image src="/images/slow_sweetness.webp" alt="A quiet tea ritual with mishri" fill sizes="100vw" /><div className="section-image-caption"><span>Everyday ritual</span><strong>Let sweetness<br />unfold slowly.</strong></div></div></section>
