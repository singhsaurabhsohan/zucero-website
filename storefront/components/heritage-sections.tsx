...
export function CollectionSection() {
  return <>
    ...
    <section id="products" className="heritage-collection">
      ...
      <header><span className="heritage-rule" /><p>Each one distinct. Each one with a story older than the brand.</p><div className="collection-launch-callout"><p className="eyebrow">Experience the goodness of the first batch</p><p>Priority access <span>·</span> Deliveries begins</p></div></header>
...
export function HeritageSections({ philosophy }: { philosophy: ReactNode }) {
  return <div className="heritage">
    <section id="process" className="heritage-dark heritage-craft">
      <div className="heritage-panorama"><Image src="/images/khand-craft-artisan-v2.png" alt="An artisan preparing fine Desi Khand in a traditional iron kadai" fill sizes="100vw" /><div className="section-image-caption craft-caption"><h2 className="overlay-section-title">The Craft</h2><strong><b>Good</b><b>takes</b><b>time.</b></strong></div></div>
