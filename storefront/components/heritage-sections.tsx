...
export function HeritageSections({ philosophy }: { philosophy: ReactNode }) {
  return <div className="heritage">
    <section id="process" className="heritage-dark heritage-craft">
      ...
      <div className="heritage-panorama"><Image src="/images/khand-craft-artisan-v2.png" alt="An artisan preparing fine Desi Khand in a traditional iron kadai" fill sizes="100vw" /><div className="section-image-caption craft-caption"><span>The Craft</span><strong><b>Good</b><b>takes</b><b>time.</b></strong></div></div>
    ...
    <section className="heritage-dark heritage-journal"><SectionDivider number="09" title="From the Journal" light /><p className="eyebrow">From the Journal</p><h2>From the journal</h2><div className="heritage-journal-grid">{[
