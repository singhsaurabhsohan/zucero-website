...
export function ProductPurchase({ product }: { product: Product }) {
  ...
  return <div className="purchase-panel">
    ...
    <VerifiedPurchaseLink className="button button-gold pdp-buy-now" href={buyLink} lines={[{ productName: product.name, variantLabel: variant.label, quantity }]}>Buy on WhatsApp</VerifiedPurchaseLink>
    ...
    <div className="pdp-sticky-buy"><span>{product.name}<small>{variant.label} · {formatPrice(variant.pricePaise)}</small></span><VerifiedPurchaseLink className="button button-dark" href={buyLink} lines={[{ productName: product.name, variantLabel: variant.label, quantity }]}>Buy on WhatsApp</VerifiedPurchaseLink></div>
  </div>;
}
